        ...
        <>
            {loading ? (
                ...
                <div className="min-w-screen min-h-screen bg-slate-300 sm:flex">
                    <div className="hidden sm:w-2/3 sm:bg-slate-300 sm:flex sm:justify-center sm:items-center min-h-screen ">
                        <div className="w-1/2 p-4 rounded-lg bg-white flex flex-col items-center min-h-[82%]">
